        ...
        <div className={"topbar " + (isOpen && "active")}> {/* "topbar " + (open && "active") means that if isOpen is true, then append topbar to active. NOTE THAT THERE IS A SPACE AFTER "topbar". */}
            <div className="wrapper">
                <div className="left">
                    ...
                    <div className="itemContainer">
                        <a href="mailto:shashwat.doshi@mail.utoronto.ca" target="_blank" id="topbarLink"><Mail className="icon"/>
                        <span>shashwat.doshi@mail.utoronto.ca</span></a>
                    </div>
                    <div className="itemContainer">
                        <a href="https://drive.google.com/file/d/1Vf82NTTNe0NpZNjhx1ZybkfnnS8P8xXF/view?usp=sharing" target="_blank" id="topbarLink"><PictureAsPdf className="icon"/>
                        <span>Resume</span></a>
                    </div>
                </div>
                <div className="right">
